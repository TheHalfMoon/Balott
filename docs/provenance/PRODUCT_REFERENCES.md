# Balott Product and Market Reference Addendum

**Reviewed:** 2026-09-15

This addendum preserves exact public URLs for product references discussed during Balott shaping. These are behavioral/market references unless an immutable source repository is separately available and qualified.

| Product/reference | URL | Use in Balott research |
| --- | --- | --- |
| Kammelna | https://www.kammelna.com | incumbent product baseline |
| Kammelna Google Play | https://play.google.com/store/apps/details?id=com.remalit.kammelna | current features/subscription/update evidence |
| Kammelna App Store | https://apps.apple.com/sa/app/id537025426 | current product/update/event evidence |
| VIP Baloot Google Play | https://play.google.com/store/apps/details?id=co.tamatem.vipbaloot | social/team/event baseline |
| VIP Baloot App Store | https://apps.apple.com/sa/app/id1136146687 | current product/release evidence |
| Tarbi3ah Baloot App Store | https://apps.apple.com/sa/app/id1461692005 | club/tournament/reward baseline |
...
Founder permission does not create source bytes for products whose implementation is not available to Balott. Product observation may inform requirements and competitive analysis, but direct code adoption requires an accessible, immutable source identity plus the provenance controls in `SOURCE_USE_AUTHORIZATION.md`.
